        ...
        <div className="main contact-margin-top" id="contact">
            <div className="contact-div-main">
                <div className="contact-header">
                    ...
                    <p className={isDark ? "dark-mode subTitle contact-subtitle": "subTitle contact-subtitle"}>{contactInfo.subtitle}</p>
                ...
                <div className="contact-image-div">
                    <img alt="Mayur Working" src={require("../../assets/images/contactMail.webp")}></img>
                </div>
            </div>
        </div>
        </Fade>
